...
public class Rect2f {
    ...
    public Rect2f(double x, double y, double width, double height) {
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
    ...
    public Rect2f(Point p1, Point p2) {
    ...
    public Rect2f(Point p, Size s) {
        this(p.x, p.y, s.width, s.height);
    }

    public Rect2f(double[] vals) {
        set(vals);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof Rect2f)) return false;
        Rect2f it = (Rect2f) obj;
